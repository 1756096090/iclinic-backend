...
-- 2. BRANCHES
-- =====================================================
INSERT INTO branches (id, name, address, branch_type, type, company_id, has_laboratory, timezone) VALUES (1, 'Sucursal Centro Quito', 'Av. Patria N31-169, Quito', 'CLINIC', 'CLINIC', 1, true, 'America/Guayaquil');
INSERT INTO branches (id, name, address, branch_type, type, company_id, has_laboratory, timezone) VALUES (2, 'Sucursal Mariscal Quito', 'Mariscal Sucre y 6 de Diciembre, Quito', 'CLINIC', 'CLINIC', 1, true, 'America/Guayaquil');
INSERT INTO branches (id, name, address, branch_type, type, company_id, has_laboratory, timezone) VALUES (3, 'Sucursal Centro Bogotá', 'Carrera 7 #32-16, Bogotá', 'CLINIC', 'CLINIC', 2, true, 'America/Bogota');

-- =====================================================
-- 3. USERS (Staff)
-- =====================================================
INSERT INTO users (id, first_name, last_name, email, phone, role, document_type, active, created_at, updated_at, user_type, company_id, branch_id, document_number, keycloak_user_id, subject_type, tokens_valid_from) VALUES (1, 'Dr. Juan', 'García López', 'juan.garcia@clinica.ec', '+593987654321', 'ADMIN', 'CEDULA_EC', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ECUADORIAN', 1, 1, '1718888888', '00000000-0000-4000-8000-000000000001', 'HUMAN', CURRENT_TIMESTAMP);
INSERT INTO users (id, first_name, last_name, email, phone, role, document_type, active, created_at, updated_at, user_type, company_id, branch_id, document_number, keycloak_user_id, subject_type, tokens_valid_from) VALUES (2, 'Dra. María', 'Rodríguez Pérez', 'maria.rodriguez@clinica.ec', '+593999876543', 'DENTIST', 'CEDULA_EC', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ECUADORIAN', 1, 1, '1799999999', '00000000-0000-4000-8000-000000000002', 'HUMAN', CURRENT_TIMESTAMP);
INSERT INTO users (id, first_name, last_name, email, phone, role, document_type, active, created_at, updated_at, user_type, company_id, branch_id, document_number, keycloak_user_id, subject_type, tokens_valid_from) VALUES (3, 'Carlos', 'Mendoza Silva', 'carlos.mendoza@clinica.ec', '+593998765432', 'RECEPTIONIST', 'CEDULA_EC', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ECUADORIAN', 1, 1, '1705550000', '00000000-0000-4000-8000-000000000003', 'HUMAN', CURRENT_TIMESTAMP);
INSERT INTO users (id, first_name, last_name, email, phone, role, document_type, active, created_at, updated_at, user_type, company_id, branch_id, document_number, keycloak_user_id, subject_type, tokens_valid_from) VALUES (4, 'Dr. Pedro', 'Martínez López', 'pedro.martinez@clinica.co', '+573001234567', 'ADMIN', 'CEDULA_CO', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'COLOMBIAN', 2, 3, '79876543', '00000000-0000-4000-8000-000000000004', 'HUMAN', CURRENT_TIMESTAMP);
...
INSERT INTO users (id, first_name, last_name, email, role, document_type, active, is_platform_admin, created_at, updated_at, user_type, company_id, branch_id, keycloak_user_id, subject_type, tokens_valid_from) VALUES (5, 'Isaac', '', 'isaaccs2003@gmail.com', 'SUPER_ADMIN', 'PASSPORT', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ECUADORIAN', 1, 1, '00000000-0000-4000-8000-000000000005', 'HUMAN', CURRENT_TIMESTAMP);
